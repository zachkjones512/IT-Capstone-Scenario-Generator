...
def create_presentation(inputslist):
    ...
    body_text_dict = [
        ...
        "Congratulations, you've made it to level 3! " + " Did you know that less than one percent of cyber incidents result in prosecution? We were lucky to catch " + inputslist[1] + " eating " + inputslist[7] + " across the street from the manufacturing plant.\n\nWhen we caught them, they had written on a napkin the phrase 'Level 3 - Base64'. Possibly another type of encryption?\n\nCommands you may use: 'cat', 'strings', 'base64', 'cd'",
